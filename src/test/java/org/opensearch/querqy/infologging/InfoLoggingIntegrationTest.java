...
import org.opensearch.querqy.rewriter.ReplaceRewriterFactory;
import org.opensearch.querqy.rewriter.SimpleCommonRulesRewriterFactory;
import org.opensearch.querqy.rewriterstore.Constants;
...
import org.opensearch.querqy.QuerqyPlugin;
import org.opensearch.querqy.query.InfoLoggingSpec;
...
public class InfoLoggingIntegrationTest extends OpenSearchSingleNodeTestCase  {
    ...
    public void deleteRewriterIndex() {
        try {
            client().admin().indices().prepareDelete(Constants.QUERQY_INDEX_NAME).get();
    ...
    public void testTwoRewritersOfSameTypeLoggingDetails() throws Exception {
        ...
        content1.put("class", SimpleCommonRulesRewriterFactory.class.getName());
        ...
        content2.put("class", SimpleCommonRulesRewriterFactory.class.getName());
    ...
    public void testTwoRewritersOfDifferentTypesLoggingDetails() throws Exception {
        ...
        final Map<String, Object> content1 = new HashMap<>();
        content1.put("class", ReplaceRewriterFactory.class.getName());
        final Map<String, Object> loggingConf1 = new HashMap<>();
        loggingConf1.put("sinks", Collections.singletonList("log4j"));
        content1.put("info_logging", loggingConf1);
