...
import org.opensearch.querqy.rewriterstore.NodesClearRewriterCacheResponse;
...
import org.opensearch.querqy.rewriterstore.NodesClearRewriterCacheRequest;
...
public class RewriterShardContextsTest extends OpenSearchIntegTestCase {
    ...
    protected Settings nodeSettings(final int nodeOrdinal) {
        ...
        return Settings.builder().put(super.nodeSettings(nodeOrdinal))
                .put(Constants.SETTINGS_QUERQY_INDEX_NUM_REPLICAS, NUM_DOT_QUERY_REPLICAS)
                .build();
    }
    ...
    public void testClearRewritersFromCache() throws Exception {
        ...
        final DeleteResponse deleteResponse = client().prepareDelete(Constants.QUERQY_INDEX_NAME, null, "r2").execute().get();
