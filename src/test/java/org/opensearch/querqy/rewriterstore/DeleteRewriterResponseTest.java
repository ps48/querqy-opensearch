...
public class DeleteRewriterResponseTest {
    ...
    public void testStreamSerialization() throws IOException {
        ...
        final DeleteResponse deleteResponse1 = new DeleteResponse(new ShardId("idx1", "shard1", 1), Constants.QUERQY_INDEX_NAME, "id1",
                11, 2L, 8L, true);
    ...
    public void testToJson() throws IOException {
        ...
        final DeleteResponse deleteResponse = new DeleteResponse(new ShardId("idx1", "shard1", 1), Constants.QUERQY_INDEX_NAME, "id1", 11,
                2L, 8L, true);
