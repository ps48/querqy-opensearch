...
package org.opensearch.querqy.query;

import static org.opensearch.querqy.query.RequestUtils.fieldBoostModelToString;
import static org.opensearch.querqy.query.RequestUtils.paramToFieldBoostModel;
import static org.opensearch.querqy.query.RequestUtils.paramToQueryFieldsAndBoosting;
...
public class QuerqyQueryBuilder extends AbstractQueryBuilder<QuerqyQueryBuilder> {
    ...
    /**
     * Indicates whether some other {@link org.opensearch.index.query.QueryBuilder} object of the same type is
     * "equal to" this one.
     *
