...
public class MatchingQuery implements NamedWriteable, ToXContent {
    ...
    public XContentBuilder toXContent(final XContentBuilder builder, final Params params) throws IOException {
        ...
        final Optional<String> optSimilarityScoring = RequestUtils.querySimilarityScoringToString(similarityScoring);
    ...
    public void setSimilarityScoring(final String similarityScoring) {
        setSimilarityScoring(RequestUtils.paramToQuerySimilarityScoring(similarityScoring, FIELD_SIMILARITY_SCORING));
    }
