...
public class RewrittenQueries implements NamedWriteable, ToXContent {
    ...
    public XContentBuilder toXContent(final XContentBuilder builder, final Params params) throws IOException {
        ...
        final Optional<String> scoringOpt = RequestUtils.querySimilarityScoringToString(similarityScoring);
    ...
    public void setSimilarityScoring(final String boostQuerySimilarityScoring) {
        ...
        this.similarityScoring = RequestUtils.paramToQuerySimilarityScoring(boostQuerySimilarityScoring,
