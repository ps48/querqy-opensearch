...
import org.opensearch.querqy.rewriter.numberunit.NumberUnitConfigObject;
import org.opensearch.querqy.OpenSearchRewriterFactory;
import org.opensearch.querqy.rewriter.numberunit.NumberUnitQueryCreatorOpenSearch;
...
public class NumberUnitRewriterFactory extends OpenSearchRewriterFactory {
    ...
    public void configure(Map<String, Object> config) {
        ...
        try {
            ...
            numberUnitConfigObject = mapper.readValue(
